...
class SpecfileParserScanner(runtime.Scanner):
    patterns = [
        ...
        ('CONDITION_BODY', re.compile('(?!(endif|if))[\\W\\w]*?(?=%(else|endif|if))')),
    ...
    def condition_definition(self, _parent=None):
        ...
        while self._peek('CONDITION_END_KEYWORD', 'CONDITION_ELSE_KEYWORD', 'CONDITION_BEG_KEYWORD', 'CONDITION_BODY', context=_context) != 'CONDITION_END_KEYWORD':
            ...
            if _token == 'CONDITION_BEG_KEYWORD':
                condition_definition = self.condition_definition(_context)
                block.content.append(condition_definition)	# <---- ADD
                ...
                PERCENT_SIGN = self._scan('PERCENT_SIGN', context=_context)
                if self._peek('CONDITION_BEG_KEYWORD', 'PERCENT_SIGN', 'CONDITION_ELSE_KEYWORD', 'CONDITION_END_KEYWORD', 'CONDITION_BODY', 'TAG_KEY', 'COMMENT', 'END', context=_context) == 'CONDITION_BEG_KEYWORD':
